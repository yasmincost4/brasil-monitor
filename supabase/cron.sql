...
-- O <PROJECT_REF> nas URLs já está preenchido com dafpegbjldekbfdbcfuv.
...
select cron.schedule('coletor-agencia-brasil', '*/10 * * * *',
  $$ select net.http_post(
       url := 'https://dafpegbjldekbfdbcfuv.supabase.co/functions/v1/coletor-agencia-brasil',
...
select cron.schedule('coletor-inpe-queimadas', '*/20 * * * *',
  $$ select net.http_post(
       url := 'https://dafpegbjldekbfdbcfuv.supabase.co/functions/v1/coletor-inpe-queimadas',
       headers := jsonb_build_object('Content-Type','application/json',
         'Authorization','Bearer ' || (select decrypted_secret from vault.decrypted_secrets where name = 'service_key'))); $$);

select cron.schedule('coletor-bcb-sgs', '0 6 * * *',
  $$ select net.http_post(
       url := 'https://dafpegbjldekbfdbcfuv.supabase.co/functions/v1/coletor-bcb-sgs',
       headers := jsonb_build_object('Content-Type','application/json',
         'Authorization','Bearer ' || (select decrypted_secret from vault.decrypted_secrets where name = 'service_key'))); $$);
...
select cron.schedule('coletor-usgs-terremotos', '*/15 * * * *',
  $$ select net.http_post(
       url := 'https://dafpegbjldekbfdbcfuv.supabase.co/functions/v1/coletor-usgs-terremotos',
       headers := jsonb_build_object('Content-Type','application/json',
         'Authorization','Bearer ' || (select decrypted_secret from vault.decrypted_secrets where name = 'service_key'))); $$);

select cron.schedule('coletor-inmet-alertas', '*/45 * * * *',
  $$ select net.http_post(
       url := 'https://dafpegbjldekbfdbcfuv.supabase.co/functions/v1/coletor-inmet-alertas',
       headers := jsonb_build_object('Content-Type','application/json',
         'Authorization','Bearer ' || (select decrypted_secret from vault.decrypted_secrets where name = 'service_key'))); $$);
...
select cron.schedule(
  ...
  $$ select net.http_post(
       url := 'https://dafpegbjldekbfdbcfuv.supabase.co/functions/v1/coletor-camara-votacoes',
       headers := jsonb_build_object('Content-Type','application/json',
         'Authorization','Bearer ' || (select decrypted_secret from vault.decrypted_secrets where name = 'service_key'))); $$
);
...
select cron.schedule(
  ...
  $$ select net.http_post(
       url := 'https://dafpegbjldekbfdbcfuv.supabase.co/functions/v1/coletor-factcheck',
       headers := jsonb_build_object('Content-Type','application/json',
         'Authorization','Bearer ' || (select decrypted_secret from vault.decrypted_secrets where name = 'service_key'))); $$
);
...
select cron.schedule(
  ...
  $$ select net.http_post(
       url := 'https://dafpegbjldekbfdbcfuv.supabase.co/functions/v1/coletor-transparencia',
       headers := jsonb_build_object('Content-Type','application/json',
         'Authorization','Bearer ' || (select decrypted_secret from vault.decrypted_secrets where name = 'service_key'))); $$
);
...
select cron.schedule(
  ...
  $$ select net.http_post(
       url := 'https://dafpegbjldekbfdbcfuv.supabase.co/functions/v1/coletor-noticias-fiscais',
       headers := jsonb_build_object('Content-Type','application/json',
         'Authorization','Bearer ' || (select decrypted_secret from vault.decrypted_secrets where name = 'service_key'))); $$
);
...
select cron.schedule('processador-clusters', '*/30 * * * *',
  $$ select net.http_post(url:='https://dafpegbjldekbfdbcfuv.supabase.co/functions/v1/processador-clusters',
...
select cron.schedule('analisador-vieses', '15 */1 * * *',
  $$ select net.http_post(url:='https://dafpegbjldekbfdbcfuv.supabase.co/functions/v1/analisador-vieses',
     headers:=jsonb_build_object('Content-Type','application/json','Authorization','Bearer ' || (select decrypted_secret from vault.decrypted_secrets where name = 'service_key'))); $$);
-- Brief diário (IA): 06:30
select cron.schedule('brief-diario', '30 6 * * *',
  $$ select net.http_post(url:='https://dafpegbjldekbfdbcfuv.supabase.co/functions/v1/brief-diario',
     headers:=jsonb_build_object('Content-Type','application/json','Authorization','Bearer ' || (select decrypted_secret from vault.decrypted_secrets where name = 'service_key'))); $$);
